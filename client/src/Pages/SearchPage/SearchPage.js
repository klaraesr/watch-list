      ...
      let {movies, numberOfResults, numberOfPages} = this.state
        return (
            <div className="container appContainer">
                ...
                <div id='dropRow' className='row'>
                  <Target droppedItem={this.state.droppedItem} onDrop={this.onDrop} listType='toWatch'/>
                  <Target droppedItem={this.state.droppedItem} onDrop={this.onDrop} listType='watched'/>
                </div>
                <div className='grid'>
                    {movies.map(movie =>
...
//
// const SearchWrapper = DragDropContext(HTML5Backend)(SearchPage);
// const rootElement = document.getElementById("root");
// ReactDOM.render(<SearchWrapper />, rootElement);
